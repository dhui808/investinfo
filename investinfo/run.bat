...
set LIBREOFFICE_LIB=%LIBREOFFICE_PATH%\ridl.jar;%LIBREOFFICE_PATH%\unoil.jar;%LIBREOFFICE_PATH%\unoloader.jar;%LIBREOFFICE_PATH%\juh.jar;%LIBREOFFICE_PATH%\jurt.jar;%LIBREOFFICE_PATH%\officebean.jar
...
java -classpath %CP% cftc.Main %1 %2 %3 %4 %5