...
set CP=target\classes;..\jloputility\target\classes;%LIB%;%LIBREOFFICE_LIB%;%LIB_PATH%\jsoup-1.14.2.jar;%LIB_PATH%\commons-io-2.7.jar;%LIB_PATH%\jackson-core-2.11.2.jar;%LIB_PATH%\jackson-databind-2.11.2.jar;%LIB_PATH%\jackson-annotations-2.11.2.jar;%LIB_PATH%\mysql-connector-java-8.0.21.jar;%LIB_PATH%\commons-lang3-3.11.jar
